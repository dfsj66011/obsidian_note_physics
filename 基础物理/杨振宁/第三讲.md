...
9.8 meters per second square. I wrote a minus sign in front. If you take the axis to go upwards, if you take the axis to go downwards, of course it becomes a plus sign. (9.8米每二次方秒。我在前面写了个负号。如果你设定坐标轴向上为正方向，向下为负方向，当然它就变成了正号。)

（开篇这一小段没有额外上下文，应该是在介绍自由落体加速度大小）
...
![[Pasted image 20251019203908.png]]
...
（《杨振宁文集》一书中的 “优雅的四元数”章节，我看到的版本是在第 35 页，这部分内容会在文末展出。）
...
（《杨振宁文集》中的“负一的平方根、复相位与薛定谔”，第 636 页，这部分内容会在文末展出）
